  ...
  return (
    <div className="card shadow-sm rounded-4 my-5 section">
      <div className="card-body p-4">
        ...
        <p className="text-secondary small">Subscribe by entering your email below to stay updated about the latest things I've created and discover the great finds I've come across on the internet.</p>
        <form className="row g-2 align-items-center">
          <div className="col-md-4">
            <input type="text" className="form-control" placeholder="John Doe" name="name" />
          </div>
          <div className="col-md-5">
            <input type="email" className="form-control" placeholder="your@email.com" name="email" />
          </div>
      ...
      <div className="card-footer bg-transparent border-top border-dashed p-4">
        <div className="row g-3 align-items-center">
          <div className="col-md-9">
            <p className="mb-0 text-muted small">Alternatively, you can schedule a call with me to discuss anything you'd like. I'm always open to new ideas and opportunities.</p>
          </div>
          <div className="col-md-3">
